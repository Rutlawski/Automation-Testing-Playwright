...
test.skip("Fills in user's adress details with numbers and verifies error", async ({page}) => {
    ...
    await adressDetailsPage.fillAdressDetailsWithNumber(userDetails);
    await expect(adressDetailsPage.errorMessage).toHaveText("Error: First name can't contain numbers");
